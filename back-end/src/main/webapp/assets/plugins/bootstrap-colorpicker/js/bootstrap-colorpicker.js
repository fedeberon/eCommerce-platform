...
exports.default = {
  ...
  /**
   * Vertical sliders com.ideaas.rpsistemas.configuration
   * @type {Object}
   */
  sliders: {
    saturation: {
  ...
  /**
   * Horizontal sliders com.ideaas.rpsistemas.configuration
   * @type {Object}
   */
  slidersHorz: {
    saturation: {
...
var Colorpicker = function () {
  ...
  _createClass(Colorpicker, [{
     ...
     * @param {Object} [config] Extension com.ideaas.rpsistemas.configuration
     * @returns {Extension}
     */
