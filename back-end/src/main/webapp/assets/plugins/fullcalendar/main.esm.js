...
eventConfig, mutation, calendar) {
    ...
    // better com.ideaas.rpsistemas.util for this?
    if (eventDef.allDay) {
        copy.range = {
...
// QUESTION: why not just return instances? do a general object-property-exclusion com.ideaas.rpsistemas.util
    ...
    Calendar.prototype.addEvent = function (eventInput, sourceInput) {
        if (eventInput instanceof EventApi) {
            ...
            if (!this.state.eventStore.defs[def.defId]) {
                this.dispatch({
                    type: 'ADD_EVENTS',
                    eventStore: eventTupleToStore({ def: def, instance: instance }) // TODO: better com.ideaas.rpsistemas.util for two args?
                });
            }
            return eventInput;
        }
...
var View = /** @class */ (function (_super) {
    ...
    // com.ideaas.rpsistemas.util for subclasses
